...
root = Tk()
root.title("Wikipidia Created By Shahzaib")
root.config(bg="#e36521")
topFrame = Frame(root, bg="#e36521")
...
buttomFrame = Frame(root, bg="#e36521")
scroll = Scrollbar(buttomFrame)
text = Text(buttomFrame, width=30, height=15, wrap=WORD, font="Lucida 14", bg="white", yscrollcommand=scroll.set)
